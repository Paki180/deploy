...
#                 insights = {
#                     0: "💡 Target with mid-range products and family campaigns",
#                     1: "💡 Focus on value deals and budget options",
#                     2: "💡 Promote premium products and exclusive offers",
#                     3: "💡 VIP treatment, luxury products, personalized service"
#                 }
...
print(f"🛑 Press the stop button (■) to shut down")
print("="*60)
